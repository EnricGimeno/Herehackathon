...
<html lang="en">
  <head>
    ...
    <!-- To use cool icons from  https://fontawesome.com -->
        ...
        <div class="col-md-3 float-left col-1 pl-0 pr-0 collapse width show" id="sidebar">
          <div class="list-group border-0 card text-center text-md-left">
            <a href="#menu1" class="list-group-item d.inline-block collapsed" data-toggle="collapse" data-parent="#sidebar" aria-expanded="false">
              <i class="fa fa-dashboard"></i><span class="hidden-sm-down">Account</span>
            </a>
            ...
            <a href="#" class="list-group-item d-inline-block collapse" data-parent="#sidebar"><i class="fa fa-film"></i><span class="hidden-sm-down">Home</span></a>
          </div>
        </div>
